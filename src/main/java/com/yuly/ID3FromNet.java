...
/**
 * Created by yuliyao on 2017/1/18.
 */
public class ID3FromNet {
    ...
    public static void main(String[] args) {
        ID3FromNet inst = new ID3FromNet();
        inst.readARFF(new File("E:\\00code\\machine-learning-demo\\src\\main\\resources\\weathre.arff"));
        inst.setDec("play");
